...
#案例5：查询姓名中包含第二个字符为_的员工信息（通过\来转义）
SELECT *
FROM employees
...
SELECT *
FROM employees
WHERE last_name LIKE '_$_%' ESCAPE '$'; -- 通过ESCAPE来说明'$'是转义字符
